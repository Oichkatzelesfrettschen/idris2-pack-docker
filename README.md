...
[![Idris2 Version](https://img.shields.io/badge/idris2-0.8.0-green)](https://www.idris-lang.org/)
...
A production-ready Docker image for **Idris2 0.8.0** with the **Pack package manager**, built on Debian 13 (Trixie). Get a fully-configured Idris2 development environment running in seconds on any platform with Docker.

## Features

- **Idris2 0.8.0** - Latest stable release with full standard library
